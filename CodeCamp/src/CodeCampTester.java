...
public class CodeCampTester {
    ...
    public static void main(String[] args){
        ...
        /*This is the shareBirthday test*/
        int NUM_DAYS = 365;
        int numRun = 50000;
        for (int i = 2; i <= 100; i++) {
        	int count = CodeCamp.numCount(i, NUM_DAYS, numRun);
        	System.out.printf("Num people: %2d" +
							   ", number of experiments with one or more shared birthday: %5d" + 
							   ", percentage: %.3f\n",i,count,(count * 100.0 / numRun));
		}
        //test 1, hamming distance
        
    	
        int[] h1 = { 3, 4, 5, 4, 3, 2, 1,1,2};
